...
public class DomainConditions {
    ...
    public static <T> void checkEntityDoesNotExist(@Nullable T entity) throws EntityAlreadyExistsException {
        if (entity != null) {
            throw new EntityAlreadyExistsException();
        }
    }

    public static <T> void checkEntityDoesNotExist(@Nullable Boolean exists) throws EntityAlreadyExistsException {
    ...
    public static <T> T checkNonnullArgument(@Nullable T entity, ErrorType errorType, String tag) {
        if (entity == null) {
            String name = errorType != null ? errorType.name() : null;
            String msg = errorType != null ? errorType.getMessage() : null;
            log.warn("{} {} - Entity Does not exist", tag, errorType);
            throw new BadRequestException(name, msg, null);
        }
        return entity;
    }
